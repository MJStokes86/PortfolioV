			...
			<div class="container">
				...
				<span class="icon-bar"></span>
				  ...
				  <!-- START LOGO DESIGN AREA -->
						<div class="logo">
							<a href="http://localhost/wordpress" class="navbar-brand navbar-text-color"><img src="<?php bloginfo( 'template_directory' ); ?>/lib/img/Logo.png"><span>Michael J. Stokes</span></a>

							<!-- <a href="http://mjstokes.com" class="navbar-brand navbar-text-color"><img src="<?php bloginfo( 'template_directory' ); ?>/lib/img/Logo.png"><span>Michael J. Stokes</span></a> -->
						</div>
